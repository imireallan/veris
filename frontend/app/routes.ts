...
export default [
  ...
  route("", "routes/dashboard_layout.tsx", [
    ...
    route("organizations/:orgId/templates/:templateId/instantiate", "routes/organizations.$orgId.templates.$templateId.instantiate.tsx"),
    route("organizations/:orgId/frameworks", "routes/organizations.$orgId.frameworks.tsx"),
    route("organizations/:orgId/frameworks/:frameworkSlug", "routes/organizations.$orgId.frameworks.$frameworkId.tsx"),
