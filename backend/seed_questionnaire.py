...
from assessments.models import AssessmentTemplate, AssessmentQuestion, Assessment, AssessmentResponse
...
def seed_data():
    ...
    # Questions
    questions_data = [
        {"text": "Do you have a formal sustainability policy?", "category": "Governance", "scoring_criteria": {"Yes": 10, "No": 0}},
        {"text": "How do you measure carbon emissions?", "category": "Environmental", "scoring_criteria": {"Detailed": 10, "Basic": 5, "None": 0}},
        {"text": "Do you report on labor practices?", "category": "Social", "scoring_criteria": {"Public": 10, "Internal": 5, "None": 0}},
    ]
