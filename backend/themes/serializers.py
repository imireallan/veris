...
from themes.utils import hex_to_hsl, hsl_to_hex
...
class ThemeSerializer(serializers.ModelSerializer):
    ...
    secondary_foreground_hsl_dark = serializers.CharField(write_only=True, required=False)
    ...
    destructive_foreground_hsl_dark = serializers.CharField(write_only=True, required=False)
    ...
    class Meta:
        ...
        fields = [
            ...
            "success",
            # Dark mode colors
            "primary_dark", "primary_foreground_dark",
            "secondary_dark", "secondary_foreground_dark",
            "accent_dark", "accent_foreground_dark",
            "background_dark", "foreground_dark",
            "muted_dark", "muted_foreground_dark",
            "card_dark", "card_foreground_dark",
            "border_dark",
            "destructive_dark", "destructive_foreground_dark",
            "success_dark",
            # Light mode HSL input
            "primary_hsl", "primary_foreground_hsl",
            "secondary_hsl", "secondary_foreground_hsl",
            "accent_hsl", "accent_foreground_hsl",
            "background_hsl", "foreground_hsl",
            "muted_hsl", "muted_foreground_hsl",
            "card_hsl", "card_foreground_hsl",
            "border_hsl",
            "destructive_hsl", "destructive_foreground_hsl",
            "success_hsl",
            # Dark mode HSL input
            "primary_hsl_dark", "primary_foreground_hsl_dark",
            "secondary_hsl_dark", "secondary_foreground_hsl_dark",
            "accent_hsl_dark", "accent_foreground_hsl_dark",
            "background_hsl_dark", "foreground_hsl_dark",
            "muted_hsl_dark", "muted_foreground_hsl_dark",
            "card_hsl_dark", "card_foreground_hsl_dark",
            "border_hsl_dark",
            "destructive_hsl_dark", "destructive_foreground_hsl_dark",
            "success_hsl_dark",
            # Branding
    ...
    def get_primary_foreground(self, obj: Theme) -> str:
        h, s, l = self._parse_hsl(self.get_primary(obj))
        return self._get_hsl("#FFFFFF") if l < 50 else self._get_hsl("#000000")
    ...
    def get_secondary_foreground(self, obj: Theme) -> str:
        h, s, l = self._parse_hsl(self.get_secondary(obj))
        return self._get_hsl("#FFFFFF") if l < 50 else self._get_hsl("#000000")
    ...
    def get_accent_foreground(self, obj: Theme) -> str:
        h, s, l = self._parse_hsl(self.get_accent(obj))
        return self._get_hsl("#FFFFFF") if l < 50 else self._get_hsl("#000000")
    ...
    def get_primary_foreground_dark(self, obj: Theme) -> str:
        h, s, l = self._parse_hsl(self.get_primary_dark(obj))
        return self._get_hsl("#FFFFFF") if l < 50 else self._get_hsl("#000000")
    ...
    def get_secondary_foreground_dark(self, obj: Theme) -> str:
        h, s, l = self._parse_hsl(self.get_secondary_dark(obj))
        return self._get_hsl("#FFFFFF") if l < 50 else self._get_hsl("#000000")
    ...
    def get_accent_foreground_dark(self, obj: Theme) -> str:
        h, s, l = self._parse_hsl(self.get_accent_dark(obj))
        return self._get_hsl("#FFFFFF") if l < 50 else self._get_hsl("#000000")
