...
MEDIA_URL = "/media/" if not env.bool("USE_S3", default=False) else f"https://{env('AWS_S3_CUSTOM_DOMAIN', default='')}/"
...
AWS_S3_CUSTOM_DOMAIN = env("AWS_S3_CUSTOM_DOMAIN", default="")  # Optional: CloudFront domain
