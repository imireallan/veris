...
urlpatterns = [
    ...
    path("settings/<uuid:org_id>/frameworks/", views.framework_settings, name="framework_settings"),
    path("settings/<uuid:org_id>/users/", views.user_settings, name="user_settings"),
    path("settings/<uuid:org_id>/integrations/", views.integrations_settings, name="integrations"),
